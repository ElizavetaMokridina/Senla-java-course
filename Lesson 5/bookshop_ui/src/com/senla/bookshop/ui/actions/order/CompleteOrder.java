...
public class CompleteOrder implements IAction{
	private Scanner scanner;
	private Logger logger = Logger.getLogger(CompleteOrder.class);
	@Override
	public void execute() {
		...
		try {
			BookShop.getInstance().completeOrder(ListWorker.getIdByIndex(index, OrderStorage.getOrders()));
